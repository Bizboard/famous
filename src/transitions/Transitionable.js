...
export default class Transitionable {
  ...
  registerMethod(name, engineClass) {
  ...
  _loadNext() {
      ...
      this._engineInstance.set(endValue, transition, this._loadNext());
  }
  ...
  set(endState, transition, callback) {
      ...
      if (!this.currentAction) this._loadNext();
      return this;
  }
   ...
   */
  reset(startState, startVelocity) {
      this._currentMethod = null;
      this._engineInstance = null;
      this._callback = undefined;
